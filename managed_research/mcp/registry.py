...
_DEFAULT_REQUIRED_SCOPES_BY_TOOL_NAME: dict[str, tuple[str, ...]] = {
    ...
    "smr_get_objective_status": READ_SCOPES,
    "smr_milestones": WRITE_SCOPES,
    ...
    "smr_get_project_resource_limits": READ_SCOPES,
    "smr_get_project_progress_toward_resource_limits": READ_SCOPES,
